...
that application runners (C<PAGI::Server::Runner>'s C<-s CLASS> option, deployment
...
See C<PAGI::Server::Runner> for the reference runner implementation and
C<PAGI::Server> for the reference server.
