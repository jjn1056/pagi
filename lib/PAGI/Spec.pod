...
I<Note: code examples use modern Perl with subroutine signatures for clarity.
This is a documentation preference and B<not> a requirement of the PAGI
specification.>
...
Applications are written as asynchronous subroutines using C<Future::AsyncAwait>. They receive a C<scope> describing the connection, and two coderefs, C<$recv> and C<$send>, which return Futures representing event input and output.
