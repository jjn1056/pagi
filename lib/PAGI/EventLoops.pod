...
For anything beyond a worked example, reach for a real pub/sub layer -- such as
the C<PAGI::Middleware::Channels> distribution -- rather than hand-rolling the hub.
The pattern above is what such a layer implements underneath.
