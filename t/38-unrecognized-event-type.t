...
# 2. All send handlers (HTTP, SSE, WebSocket HTTP/1.1, WebSocket HTTP/2) call this function
# =============================================================================
...
subtest 'send handlers have unrecognized type handling' => sub {
    ...
    # Count occurrences - should be exactly 4 calls (HTTP, SSE, WS HTTP/1.1, WS HTTP/2)
